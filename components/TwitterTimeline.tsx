...
function TwitterTimelineDark(props: { display: boolean }) {
    return (
        <div style={{ display: props.display ? 'flex' : 'none' }}>
            <a className="twitter-timeline" data-width="500" data-height="750" data-theme='dark' href="https://twitter.com/DropboxOSS?ref_src=twsrc%5Etfw">Tweets by DropboxOSS</a>
